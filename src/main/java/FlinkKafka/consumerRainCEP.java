    ...
    public static void main(String[] args) throws IOException {
        ...
        while (true) {
            ...
            for (ConsumerRecord<String, byte[]> record : records) {
                ...
                RainWarning warning = gsonCEP.fromJson(string, RainWarning.class);

...
public class ExtremeHotWarning {
    private WeatherEvent event1;
    private WeatherEvent event2;
    public ExtremeHotWarning(){

    }
    public ExtremeHotWarning(WeatherEvent event1, WeatherEvent event2) {
        this.event1 = event1;
        this.event2 = event2;
    }
    ...
    public String toString(){
        return String.format("Extreme hot (Avg temperature: %f, at: %s)",
                this.getAvg(),
